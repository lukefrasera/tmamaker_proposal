...
%Luke: it would be great to give examples of several images taken through the entire process (at all the resolutions you tested): 1) original image, 2) histogram, 3) smoothed hystogram with # of groups, 4) results of Kmeans. 
